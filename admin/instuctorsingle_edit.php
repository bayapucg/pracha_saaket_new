                                    ...
                                    <table id="myTable" class="table table-list">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" class="form-control" name="bspecification" placeholder="Enter Name"/ value="john">
                                                </td>
												<td>
                                                    <input type="text" class="form-control" name="bspecification" placeholder="Enter Specification"/ value="java specalist">
                                                </td>
												<td>
                                                    <input type="text" class="form-control" name="bspecification" placeholder="Enter Content"/ value="Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when ...">
                                                </td>
                                                <td>&nbsp;</td>
                                            </tr>
                                        </tbody>
