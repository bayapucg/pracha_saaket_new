						...
						<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="row">
										<div class="col-lg-6">
											<label for="exampleInputemailid">Time From</label>
											<input type="time" class="form-control" id="exampleInputemailid" name="emailid" placeholder="Enter Email id">
											</div>
											<div class="col-lg-6">
												<label for="exampleInputemailid">Time To</label>
												<input type="time" class="form-control" id="exampleInputemailid" name="emailid" placeholder="Enter Email id">
												</div>
											</div>
										</div>
