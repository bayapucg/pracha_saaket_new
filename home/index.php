<?php include('header.php'); ?>
    ...
    <section id="slider-part" class="slider-active" style="">
        <div class="single-slider bg_cover pt-85" style="background-image: url(img/s-1.jpg)" data-overlay="4">
            <div class="container">
                <div class="row">
                    <div class="col-xl-7 col-lg-9" >
                        <div class="slider-cont">
                            <h1 data-animation="bounceInLeft" data-delay="1s">Launch your Carrer Path with the Right Training Program  </h1>
                            <p data-animation="fadeInUp" data-delay="1.3s">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's .</p>
                            <ul>
        ...
        <div class="single-slider bg_cover pt-85" style="background-image: url(img/s-2.jpg)" data-overlay="4">
            <div class="container">
                <div class="row">
                    <div class="col-xl-7 col-lg-9">
                        <div class="slider-cont">
                            <h1 data-animation="bounceInLeft" data-delay="1s">Comprehensive Training Programs for Great IT Carrers</h1>
